...
<body>
    <div class="container">
        <h2 class="text-center mb-4">Formulir Pendaftaran Mahasiswa Baru</h2>
            ...
            <div class="col-md-6">
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tahun_ajaran" name="tahun_ajaran" value="2022/2023">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" placeholder="" id="alamat_peserta" name="alamat_peserta" style="height: 100px"></textarea>
                    </div>
                    <div class="mb-3">
